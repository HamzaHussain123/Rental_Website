            ...
            <section id='singleVilla' className='page'>
                <div className="container">
                    ...
                    <div className="images">
                        <div className="villaImg"><img src={filterVilla.image} alt={filterVilla.name} /></div>

                        <div className="otherImgs">
                            <div>
                                <img src="/landing.jpg" alt="landing" />
                                <img src="/people.jpg" alt="people" /></div>
                            <div>
                                <img src="/people2.jpg" alt="people2" />
                                <img src="/villa10.jpg" alt="villa" /></div>
                        </div>
                    </div>
                    ...
                    <div className="checkin_out">
                        <h5>Check In <span>10:30 AM</span></h5>
                        <h5>Check Out <span>12:100 PM</span></h5>
                    </div>
